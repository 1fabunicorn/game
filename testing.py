...
ignorethis.write_plaintext('articles/welcome.txt', key='resist', file_to_create='welcome.blob')
...
"""
with open('articles/welcome.txt', 'wb') as file:
    pickle.dump(cyphertext, file)

with open('articles/welcome.txt', 'rb') as file:
    new = pickle.load(file)

print(ignorethis.decrypt(new ,'resist'))
"""